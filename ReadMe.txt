...
TODO:
1. На вкладке 'Groups' обеспечить фильтацию групп по направлению обчения;
2. На вкладке 'Students' обеспечить фильтацию студентов по группе и направлению обчения;
3. Обеспечить возможность добавления, удаления и редактирования групп;
4. Обеспечить возможность добавления, удаления и редактирования студентов;
